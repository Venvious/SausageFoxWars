...
class CellLogic:
    ...
    def OnMouseUp(self, MouseEvent):
        self.HoverState()
        if(self.towerChoice == 1 and self.player.money >= 5):
            ...
            self.player.money -= 5
        elif(self.towerChoice == 2 and self.player.money >= 10):
        ...
        elif(self.towerChoice == 3 and self.player.money >= 25):
        ...
        elif(self.towerChoice == 4 and self.player.money >= 50):
